  ...
  const INITIAL_LOGS: DoseLog[] = [
    { id: 'l1', medicationId: '1', medicationName: 'Lisinopril', scheduledTime: '8:00 AM', takenAt: null, date:
  today, status: 'pending' },                                                                                   
    { id: 'l2', medicationId: '2', medicationName: 'Metformin', scheduledTime: '8:00 AM', takenAt: null, date:
  today, status: 'pending' },                                                                                   
    { id: 'l3', medicationId: '2', medicationName: 'Metformin', scheduledTime: '6:00 PM', takenAt: null, date:
  today, status: 'pending' },                                                                                   
    { id: 'l4', medicationId: '3', medicationName: 'Atorvastatin', scheduledTime: '9:00 PM', takenAt: null,
  date: today, status: 'pending' },                                                                             
    { id: 'l5', medicationId: '1', medicationName: 'Lisinopril', scheduledTime: '8:00 AM', takenAt: '8:12 AM',
  date: yesterday, status: 'taken' },                                                                           
    { id: 'l6', medicationId: '2', medicationName: 'Metformin', scheduledTime: '8:00 AM', takenAt: '8:14 AM',
  date: yesterday, status: 'taken' },                                                                           
    { id: 'l7', medicationId: '2', medicationName: 'Metformin', scheduledTime: '6:00 PM', takenAt: null, date:
  yesterday, status: 'missed' },                                                                                
    { id: 'l8', medicationId: '3', medicationName: 'Atorvastatin', scheduledTime: '9:00 PM', takenAt: '9:03 PM',
   date: yesterday, status: 'taken' },                                                                          
  ];              
