...
const styles = StyleSheet.create({
  ...
  switchBtn: { backgroundColor: '#DCFCE7', borderRadius: 10, paddingVertical: 6, paddingHorizontal: 12, marginTop: 4 },
  switchText: { fontSize: 12, color: '#16A34A', fontWeight: '600' },
  ...
  goodBadge: { backgroundColor: '#15803D', borderRadius: 8, paddingVertical: 6, paddingHorizontal: 12, alignSelf: 'flex-start', marginTop: 12 },
  goodText: { color: '#DCFCE7', fontWeight: '600' },
  warnBadge: { backgroundColor: '#EF4444', borderRadius: 8, paddingVertical: 6, paddingHorizontal: 12, alignSelf: 'flex-start', marginTop: 12 },
  warnText: { color: '#FFF', fontWeight: '600' },
  alertCard: { backgroundColor: '#FEF2F2', borderRadius: 16, padding: 16, marginBottom: 16, borderLeftWidth: 4, borderLeftColor: '#EF4444' },
  alertTitle: { fontSize: 15, fontWeight: '700', color: '#991B1B', marginBottom: 8 },
  alertRow: { fontSize: 13, color: '#7F1D1D', marginBottom: 4 },
  refillCard: { backgroundColor: '#FFFBEB', borderRadius: 16, padding: 16, marginBottom: 16, borderLeftWidth: 4, borderLeftColor: '#F59E0B' },
